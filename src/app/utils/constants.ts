...
export const FULL_DISCLOSURE = 'This is a personal hobby project to experiment with microservices. Please read the README file ' +
  'in the Github repository by following the link in the footer to know more about the project.\n' +
  'The theme of the app is for the users to share their experiences with the ongoing covid-19 pandemic.\n ' +
  '<b>Your submission data is not regulated; please do not share any sensitive information.</b>';
